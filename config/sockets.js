...
module.exports.sockets = {
  ...
  ***************************************************************************/
  ...
  // This custom onConnect function will be run each time a new client socket connects
  onConnect: async function (session, socket) {
    console.log('Inside Onconnect')
    // By default: do nothing
  },

  // This custom onDisconnect function will be run each time a client socket disconnects
  onDisconnect: async function (session, socket) {
    console.log('Inside OnDisconnect')
    // Custom onDisconnect logic
  },
  ...
  beforeConnect: function (handshake, proceed) {
    console.log('Inside beforeConnect')
